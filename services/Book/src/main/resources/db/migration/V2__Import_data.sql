...
insert into category values (5,'Tiểu thuyết','một thể loại văn xuôi có hư cấu, thông qua nhân vật, hoàn cảnh, sự việc để phản ánh bức tranh xã hội rộng lớn và những vấn đề của cuộc sống con người, biểu hiện tính chất tường thuật, tính chất kể chuyện bằng ngôn ngữ văn xuôi theo những chủ đề xác định.',current_timestamp,current_timestamp);


insert into book values (1,'Thám tử lừng danh conan tập 1',40,'update later',2.3,true,current_timestamp,current_timestamp,1,'Conan thám tử lừng danh',1);
insert into book values (2,'Thám tử lừng danh conan tập 2',50,'update later',2.3,true,current_timestamp,current_timestamp,1,'Conan thám tử lừng danh',2);
insert into book values (3,'Thám tử lừng danh conan tập 3',45,'update later',2.3,true,current_timestamp,current_timestamp,1,'Conan thám tử lừng danh',3);
insert into book values (4,'Thám tử lừng danh conan tập 4',50,'update later',2.3,true,current_timestamp,current_timestamp,1,'Conan thám tử lừng danh',4);
